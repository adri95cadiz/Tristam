...
public class OctaveFilter extends FilterAgent {
    ...
    public OctaveFilter(AgentID aid, AgentID next) throws Exception {
        super(aid, next);
    }
    ...
    public void onMessage(ACLMessage msg) {
        if(msg.getPerformativeInt() == ACLMessage.REQUEST){             // REQUEST recibido.   
            ...
            if( hashmapMensajes.containsKey(msg.getReplyWith()) ) {               
                ...
                System.out.println(this.getAid().name + ": Agree recibido desde " + msg.getSender().name + " no registrado. ID mensaje: " + msg.getReplyWith() + ". FINALIZANDO");
                fin = true;
            }            
